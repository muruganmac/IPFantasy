...
-->
	...
	<div class="container">
		<div class="navbar navbar-fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#" alt="Fantasy Football League"></a>
		...
		<center>
			...
			<br><font color = "white"><h3>SUBSTITUTION</h3></font>
		</center>
		<br><br>
		<div class="row">
 ...
 if($player1==$player2 || $player3==$player4 || $player5==$player6)
  ...
  elseif($player6==$player1 || $player6==$player2 || $player6==$player3 || $player6==$player4)
  {
   ...
   $dbhandle->query("UPDATE users set player1='".$player1."', player2='".$player2."', player3='".$player3."', player4='".$player4."', player5='".$player5."', player6='".$player6."' where user_name='".$user_name."'"); 
  //$dbhandle->query("UPDATE users SET team name='gooood' where user_name='murugan1'");
   ...
   <div class="row">
	          		<div class="form-group">
	          			<label for="Name" class="col-sm-4 control-label"><font color = "white">User Name:<font color = "red" size = "3">*</font></label>
	            		<div class="col-sm-4">
	              			<input type="text" name="username" class="form-control" id="usersname" placeholder="User name" data-validation-engine="validate[required]" data-errormessage-value-missing="Name is required!">
	            		</div>
	          		</div>
	           	</div>
	          	
				<?php
				// $qry = "Select player1,player2,player3,player4,player5,player6 from users where user_name= '".$user_name."'  ";
				// echo $qry."<br>";
				// die();
				...
				$query = mysqli_query($dbhandle," Select player1,player2,player3,player4,player5,player6 from users where user_name= '".$user_name."'  ");
...
?>
		        ...
		        <div class="row">
		        	<div class="form-group">
			          	...
			          	<div align="center">
			            	<button type="submit" class="btn btn-primary" id="register" name="submit">Change Team</button>&nbsp;&nbsp;&nbsp;
			          		<!--<button type="submit" class="btn btn-primary" id="reset" name="reset">Log In</button><a href="login.php"></a-->
			          	    <a href="players_profile.php">Continue to Profile</a>
						</div>
		       		</div>
		       	</div>
	     	</form>
